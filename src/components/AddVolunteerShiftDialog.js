...
const ConfirmRequest = ({
  ...
  $(Box, { padding: 2 },
    $(Typography, { paragraph: true }, 'Эта задача требуют наличия следующих условий, подтверждённых больницей:'),
    $(Typography, { paragraph: true, component: 'ul' },
      map(Requirement, requirements)),
    $(Typography, { paragraph: true }, 'Оставьте заявку, чтобы с вами связался координатор для подтверждения условий -- после вы сможете добавляться в смены на эту задачу'),
    $(Typography, { paragraph: true }, 'Пока идёт оформление, вы можете помочь в задачах не требующих специальных условий'))
