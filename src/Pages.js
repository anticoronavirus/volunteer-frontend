...
const texts = {
  volunteers: `
Уважаемые волонтеры! 
На данном сайте вы можете записаться в качестве медицинского волонтера в больницы г. Москвы, оказывающие помощь пациентам, зараженным коронавирусной инфекцией. 
